...
public class E01Nizovi {
	...
	public static void main(String[] args) {
		...
		// želim pohraniti temperature zadnjih 12 mjeseci
		...
		int polje[] = {1,2,3,4}; // alocirali 4 elementa niza s vrijednostima od 1 - 4.
		
		// korištenje
		// elementima iza se pristupa putem indexa. Index kreće od broja 0
