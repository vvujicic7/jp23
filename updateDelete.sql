...
select * from osoba;
update osoba set oib='56869187291' where sifra=1;
update osoba set oib='44297448533' where sifra=2;
update osoba set oib='67587738621' where sifra=3;
update osoba set oib='20748912134' where sifra=4;
update osoba set oib='96442997016' where sifra=5;
...
# svim brojevima dodjeliti iznos umanjen za 15
